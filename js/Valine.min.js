            ...
            var j = function() {
                ...
                z = function(t, n, r) {
                    ...
                    var s = t.get("link") ? /^https?\:\/\//.test(t.get("link")) ? t.get("link") : "http://" + t.get("link") : "",
                        ...
                        d = O.hide ? "" : e.cfg.enableQQ && t.get("QQAvatar") ? (0, C.default)('<img class="vimg" src="' + j(t.get("QQAvatar")) + '" referrerPolicy="no-referrer"/>') : '<img class="vimg" src="' + (O.cdn + (0, u.default)(t.get("mail")) + O.params) + '">',
