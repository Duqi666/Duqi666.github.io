...
$.ajax({
    ...
    data: {
        key: 'XDKBZ-2M6C5-HVTIU-I4ODE-UUPTQ-4EFGO',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(112.92926,28.16968, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
